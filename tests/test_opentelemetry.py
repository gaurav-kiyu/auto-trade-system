...
class TestNoOpFallback:
    ...
    @patch("core.observability.opentelemetry._check_otel_available", return_value=False)
    def test_init_tracing_enabled_no_package(self, mock_check):
...
class TestBackendSelection:
    ...
    @patch("core.observability.opentelemetry._check_otel_available", return_value=False)
    def test_default_backend_is_otlp(self, mock_check):
    ...
    @patch("core.observability.opentelemetry._check_otel_available", return_value=False)
    def test_jaeger_backend_no_package(self, mock_check):
    ...
    @patch("core.observability.opentelemetry._check_otel_available", return_value=False)
    def test_zipkin_backend_no_package(self, mock_check):
    ...
    @patch("core.observability.opentelemetry._check_otel_available", return_value=False)
    def test_unknown_backend_falls_back_to_otlp(self, mock_check):
    ...
    @patch("core.observability.opentelemetry._check_otel_available", return_value=False)
    def test_jaeger_http_endpoint_config(self, mock_check):
    ...
    @patch("core.observability.opentelemetry._check_otel_available", return_value=False)
    def test_otlp_with_custom_headers(self, mock_check):
