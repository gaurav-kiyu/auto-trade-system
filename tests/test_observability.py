...
@patch("core.observability.start_http_server")
...
@patch("core.observability.start_http_server", side_effect=OSError("port in use"))
...
@patch("core.observability.ORDER_LATENCY")
...
@patch("core.observability.ORDER_SLIPPAGE")
...
@patch("core.observability.BROKER_HEALTH")
...
@patch("core.observability.ML_FALLBACK_COUNT")
...
@patch("core.observability.DAILY_PNL")
@patch("core.observability.RISK_LIMIT_PROXIMITY")
...
@patch("core.observability.ORDER_ACK_LATENCY")
...
@patch("core.observability.ORDER_FILL_LATENCY")
...
@patch("core.observability.RECONCILIATION_LAG")
...
@patch("core.observability.BROKER_UPTIME")
