...
class TestPositionSizing:
    ...
    def test_calculate_position_size(self) -> None:
        ...
        # Capital cap: max_risk_amount = 100000*0.05=5000; one lot's SL-loss is
        # 800*50=40000 (40% of capital) >> the 5% cap, so the correct, capital-safe
        # answer is 0 lots — not >= 1. A prior formula bug divided the cap's
        # denominator by risk_per_trade again, inflating it ~50x and silently
        # disabling this backstop for scenarios exactly like this one.
        assert size == 0
