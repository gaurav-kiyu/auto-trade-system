...
class TestRunChallenge:
    ...
    def test_cli_runs(self):
        ...
        import subprocess
        # The challenge CLI scans the full codebase and takes ~30s even in
        # isolation; under full-suite CPU contention it can exceed 30s. Use a
        # generous timeout so the assertion tests behaviour, not wall-clock.
