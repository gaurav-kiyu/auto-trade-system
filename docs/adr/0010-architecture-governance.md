...
| core/signal_router.py [removed] | `core/strategy/orchestrator.py` | Merged into orchestrator |
| `core/strategy_engine_v2.py` | `core/strategy/orchestrator.py` | Dead — use StrategyOrchestrator |
| core/predictive_risk.py [removed] | `core/services/risk_service.py` | Dead module |
| core/trading_risk.py [removed] | `core/services/risk_service.py` | Dead module |
| `core/risk/risk_policy_engine.py` | `core/services/risk_service.py` | Folded into RiskService |
| core/dynamic_risk_sizer.py [removed] | `core/services/risk_service.py` | Dead module |

### Deprecated Modules (Backward Compat Shims)
- `core/strategy/orchestrator.py` — Use `core.strategy.orchestrator.StrategyOrchestrator`
- `core/signal_approval_workflow.py` — Merged into StrategyOrchestrator v2.0
- `core/services/risk_service.py` — Use `core.services.risk_service.RiskService` via `RiskPort`
...
- ADR 0012: Config System Architecture — Three-Layer Merge with Secure Secrets
