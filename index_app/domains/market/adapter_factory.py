...
def _create_nse_equity_adapter(config: dict[str, Any]) -> MarketDataPort:
    ...
    try:
        ...
        raise NotImplementedError(f"NSE equity adapter creation failed: {e}") from e
...
def _create_mcx_commodity_adapter(config: dict[str, Any]) -> MarketDataPort:
    ...
    try:
        ...
        raise NotImplementedError(f"MCX commodity adapter creation failed: {e}") from e
...
def _create_cds_currency_adapter(config: dict[str, Any]) -> MarketDataPort:
    ...
    try:
        ...
        raise NotImplementedError(f"CDS currency adapter creation failed: {e}") from e
...
def _create_nse_ws_adapter(config: dict[str, Any]) -> MarketDataPort:
    ...
    try:
        ...
        raise NotImplementedError(f"NSE WebSocket adapter creation failed: {e}") from e
