...
def build_desk_gui(ctx: dict) -> None:
    ...
    # ── Layout file path ───────────────────────────────────────────────
    _gui_layout_path = pathlib.Path(_GUI_PROJECT_ROOT) / str(_GW.get("layout_filename", "json/index_trader_gui_layout.json"))
        ...
        try:
            ...
            if struct_ok:
                ...
                if struct.get("tg_ok"):
                    ...
                    lbl_tg.config(text="Telegram: OFF \u2014 set OPBUYING_BOT_TOKEN + OPBUYING_CHAT_ID env vars for phone alerts.",
                ...
                if tg_bits:
                    ...
                    if tg_on:
                        ...
                        lbl_last_tg.config(text="Telegram off \u2014 this panel still shows setups; set OPBUYING_BOT_TOKEN + OPBUYING_CHAT_ID env vars for phone alerts.",
                                           fg="#6e7681")
    ...
    def _save_details_as() -> None:
        ...
        _stamp = now_ist().strftime("%Y%m%d_%H%M%S")
