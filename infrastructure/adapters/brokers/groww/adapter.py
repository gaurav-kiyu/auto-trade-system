"""
Groww Broker Adapter Stub (BrokerPort).

Placeholder for Groww (NextBillion Technology) broker integration.
"""
...
class GrowwBrokerAdapter(BrokerPort):
    """Groww broker adapter stub (not yet implemented)."""

    def __init__(self, config: dict[str, Any]):
        self.config = config
        self._is_connected = False
        raise NotImplementedError("GrowwBrokerAdapter is a stub — no implementation yet")
