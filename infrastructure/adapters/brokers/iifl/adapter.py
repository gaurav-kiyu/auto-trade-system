"""
IIFL Securities Broker Adapter Stub (BrokerPort).

Placeholder for IIFL (India Infoline) broker integration.
"""
...
class IIFLBrokerAdapter(BrokerPort):
    """IIFL broker adapter stub (not yet implemented)."""

    def __init__(self, config: dict[str, Any]):
        self.config = config
        self._is_connected = False
        raise NotImplementedError("IIFLBrokerAdapter is a stub — no implementation yet")
