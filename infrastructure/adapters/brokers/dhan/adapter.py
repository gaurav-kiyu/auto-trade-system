"""
Dhan Broker Adapter Stub (BrokerPort).

Placeholder for Dhan (BoB/Rakshit Securities) broker integration.
"""
...
class DhanBrokerAdapter(BrokerPort):
    """Dhan broker adapter stub (not yet implemented)."""

    def __init__(self, config: dict[str, Any]):
        self.config = config
        self._is_connected = False
        raise NotImplementedError("DhanBrokerAdapter is a stub — no implementation yet")
