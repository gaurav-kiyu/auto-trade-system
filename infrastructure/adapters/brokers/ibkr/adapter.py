"""
Interactive Brokers (IBKR) Adapter Stub (BrokerPort).

Placeholder for IBKR TWS/Gateway API integration.
"""
...
class IBKRBrokerAdapter(BrokerPort):
    """IBKR broker adapter stub (not yet implemented)."""

    def __init__(self, config: dict[str, Any]):
        self.config = config
        self._is_connected = False
        raise NotImplementedError("IBKRBrokerAdapter is a stub — no implementation yet")
