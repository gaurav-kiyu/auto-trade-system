...
class SQLiteAdapter(PersistencePort):
    ...
    def _execute(self, query: str, parameters: tuple | dict = ()) -> sqlite3.Cursor:
        ...
        with self._lock:
            try:
                ...
                raise PersistenceError(f"SQLite query failed: {e}") from e
    ...
    def _execute_many(self, query: str, parameters_list: list[tuple | dict]) -> sqlite3.Cursor:
        ...
        with self._lock:
            try:
                ...
                raise PersistenceError(f"SQLite executemany failed: {e}") from e
    ...
    def table_exists(self, table: str) -> bool:
        ...
        try:
            ...
            raise PersistenceError(f"Failed to check if table {table} exists: {e}") from e
    ...
    def create_table(self, table: str, schema: dict[str, Any]) -> bool:
        ...
        try:
            ...
            raise PersistenceError(f"Failed to create table {table}: {e}") from e
    ...
    def drop_table(self, table: str) -> bool:
        ...
        try:
            ...
            raise PersistenceError(f"Failed to drop table {table}: {e}") from e
    ...
    def create(self, table: str, data: dict[str, Any]) -> Any:
        ...
        try:
            ...
            raise PersistenceError(f"Failed to create record in {table}: {e}") from e
    ...
    def create_many(self, table: str, data_list: list[dict[str, Any]]) -> list[Any]:
        ...
        try:
            ...
            raise PersistenceError(f"Failed to create multiple records in {table}: {e}") from e
    ...
    def read(self, table: str, record_id: Any) -> dict[str, Any] | None:
        ...
        try:
            ...
            raise PersistenceError(f"Failed to read record {record_id} from {table}: {e}") from e
    ...
    def read_many(
        ...
        try:
            ...
            raise PersistenceError(f"Failed to read multiple records from {table}: {e}") from e
    ...
    def count(
        ...
        try:
            ...
            raise PersistenceError(f"Failed to count records in {table}: {e}") from e
    ...
    def update(
        ...
        try:
            ...
            raise PersistenceError(f"Failed to update record {record_id} in {table}: {e}") from e
    ...
    def update_many(
        ...
        try:
            ...
            raise PersistenceError(f"Failed to update multiple records in {table}: {e}") from e
    ...
    def delete(self, table: str, record_id: Any) -> bool:
        ...
        try:
            ...
            raise PersistenceError(f"Failed to delete record {record_id} from {table}: {e}") from e
    ...
    def delete_many(
        ...
        try:
            ...
            raise PersistenceError(f"Failed to delete multiple records from {table}: {e}") from e
    ...
    def save_state(self, state: dict[str, Any]) -> bool:
        ...
        try:
            ...
            raise PersistenceError(f"Failed to save application state: {e}") from e
    ...
    def load_state(self) -> dict[str, Any] | None:
        ...
        try:
            ...
            raise PersistenceError(f"Failed to load application state: {e}") from e
    ...
    def delete_state(self) -> bool:
        ...
        try:
            ...
            raise PersistenceError(f"Failed to delete application state: {e}") from e
    ...
    def save_trade(self, trade_data: dict[str, Any]) -> str:
        ...
        try:
            ...
            raise PersistenceError(f"Failed to save trade: {e}") from e
    ...
    def get_trade(self, trade_id: str) -> dict[str, Any] | None:
        ...
        try:
            ...
            raise PersistenceError(f"Failed to get trade {trade_id}: {e}") from e
    ...
    def get_trades(
        ...
        try:
            ...
            raise PersistenceError(f"Failed to get trades: {e}") from e
    ...
    def update_trade(self, trade_id: str, trade_data: dict[str, Any]) -> bool:
        ...
        try:
            ...
            raise PersistenceError(f"Failed to update trade {trade_id}: {e}") from e
    ...
    def save_market_data(
        ...
        try:
            ...
            raise PersistenceError(f"Failed to save market data for {symbol}: {e}") from e
    ...
    def get_market_data(
        ...
        try:
            ...
            raise PersistenceError(f"Failed to get market data for {symbol}: {e}") from e
    ...
    def get_latest_market_data(self, symbol: str) -> dict[str, Any] | None:
        ...
        try:
            ...
            raise PersistenceError(f"Failed to get latest market data for {symbol}: {e}") from e
    ...
    def append_row(self, file_path: str | Path, row: dict[str, Any]) -> bool:
        ...
        try:
            ...
            raise PersistenceError(f"Failed to append row to CSV {file_path}: {e}") from e
    ...
    def write_rows(self, file_path: str | Path, rows: list[dict[str, Any]], headers: list[str]) -> bool:
        ...
        try:
            ...
            raise PersistenceError(f"Failed to write rows to CSV {file_path}: {e}") from e
    ...
    def read_rows(self, file_path: str | Path) -> list[dict[str, Any]]:
        ...
        try:
            ...
            raise PersistenceError(f"Failed to read rows from CSV {file_path}: {e}") from e
