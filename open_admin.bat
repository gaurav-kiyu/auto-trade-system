...
title OPB Super-App - Admin Configuration Launcher
cd /d "%~dp0"

echo ======================================================================
echo  OPB SUPER-APP - ADMIN CONFIGURATION LAUNCHER
echo ======================================================================
echo.
echo  Target URL: http://localhost:8765/admin/config
echo  Function  : Admin Configuration Management and Parameter Tuning
echo.
...
echo [OK] Opening Admin Configuration Interface in default browser...
start http://localhost:8765/admin/config

echo.
echo ======================================================================
echo  ADMIN LAUNCH COMPLETE - Accessing http://localhost:8765/admin/config
echo ======================================================================
