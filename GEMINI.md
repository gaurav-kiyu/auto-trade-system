...
- **All-Theme Verification**: Every visual change must be verified across all 9 supported themes (`dark-cyber`, `nordic-frost`, `ivory-gold`, `tokyo-night`, `catppuccin-mocha`, `obsidian-gold`, `midnight-slate`, `emerald-matrix`, `dracula-purple`).
