...
class PortfolioService:
    ...
    def __init__(self, base_currency: str = "INR") -> None:
...
if __name__ == "__main__":
    ...
    class MockFill:
        def __init__(self, symbol, quantity, price, direction, timestamp=None, commission=0.0, strategy_id="") -> None:
            self.symbol = symbol
...
class PortfolioDataService:
    ...
    def __init__(self, portfolio_service: Any = None) -> None:
    ...
    def total_exposure(self) -> float:
        ...
        return sum(abs(p.market_value) for p in self._portfolio._positions.values())  # type: ignore[no-any-return]
