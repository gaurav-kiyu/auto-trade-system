...
class AssetType(Enum):
    """Canonical asset class enumeration for multi-asset trading.

    Covers all supported Indian capital market asset classes:
    index options, equities, ETFs, REITs, InvITs, SME stocks,
    futures, commodities, currency, bonds, mutual funds, and IPOs.
    """
...
LOG_DIR: str = "logs"
STATE_FILE: str = "json/trader_state.json"
TRADE_LOG_FILE: str = "trade_log.csv"
CONFIG_FILE: str = "json/config.json"
...
def is_market_open() -> bool:
    ...
    return get_market_status() == MarketStatus.OPEN  # type: ignore[no-any-return]
...
__all__ = [
    "BLOCK_NEW_ENTRIES_FROM_HOUR",
    "BLOCK_NEW_ENTRIES_FROM_MINUTE",
    "CONFIG_FILE",
    "CONTINUOUS_TRADE_START_HOUR",
    "CONTINUOUS_TRADE_START_MINUTE",
    "DEFAULTS_FILE",
    ...
    "EARLY_SESSION_END_MINUTE",
    "EARLY_SESSION_RISK_MULT",
    "LOG_DIR",
    "MARKET_CLOSED_HOUR",
    "MARKET_CLOSED_MINUTE",
    "MARKET_CLOSE_HOUR",
    "MARKET_CLOSE_MINUTE",
    "MARKET_OPEN_HOUR",
    "MARKET_OPEN_MINUTE",
