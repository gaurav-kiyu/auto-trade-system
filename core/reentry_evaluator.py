...
class ReentryTracker:
    ...
    Tracks stop-loss history, re-entry counts, and win/loss outcomes
    for scoring and cooldown decisions.
    """
    ...
    wins:                int          = 0      # profitable outcomes
    losses:              int          = 0      # unprofitable outcomes

    def record_outcome(self, was_profit: bool) -> None:
        """Record a trade outcome (win or loss) for this symbol.
