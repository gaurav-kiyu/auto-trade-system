...
class StateManager:
    ...
    def recover_state_from_db(self, broker_positions: dict[str, Any] | None = None) -> None:
    ...
    def get_consecutive_losses(self) -> int:
        ...
        return self._state.get("consecutive_losses", 0)  # type: ignore[no-any-return]
    ...
    def save(self) -> None: self.save_state()
    def load(self) -> None: self.load_state()
