...
class TelegramAuditManager:
    def __init__(self, log_file: str = "logs/telegram_audit.log") -> None:
    ...
    def record_command(self, user_id: str, username: str, command: str, args: list[str], result: str) -> None:
    ...
    def record_unauthorized_attempt(self, user_id: str, username: str, command: str) -> None:
