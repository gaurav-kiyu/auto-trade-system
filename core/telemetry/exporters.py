...
class JSONLogExporter:
    ...
    def __init__(self, collector: MetricsCollector, log: logging.Logger | None = None) -> None:
...
class PrometheusExporter:
    ...
    def serve(self, host: str = "0.0.0.0", port: int = 9090) -> None:  # nosec B104
        ...
        class _Handler(BaseHTTPRequestHandler):
            def do_GET(self) -> None:
                if self.path == "/metrics":
                    body = self.server._exporter.generate_text()
