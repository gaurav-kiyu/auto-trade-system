...
This adapter was originally created to allow the deprecated core/orchestrator.py
(removed in v2.54) to continue working. It is retained for any remaining legacy callers
transitioning to the canonical RiskService path.
...
NOTE: orchestrator.py was removed in v2.54. This adapter is retained for any remaining
legacy call paths that still reference the old RiskEngine interface.
"""
