...
class SecretHygieneChecker:
    ...
    def is_secret_key(self, key: str) -> bool:
        ...
        # Ignore environment variable names mapping (e.g., api_key_env) and notes
        if key_lower.endswith("_env") or key_lower.endswith("_var") or "_env_var" in key_lower or key_lower.startswith("_note_"):
            return False
    ...
    def check_directory(self, directory: Path, patterns: list[str] | None = None) -> SecretHygieneResult:
