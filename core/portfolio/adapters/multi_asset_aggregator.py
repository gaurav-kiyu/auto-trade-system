...
from core.domains.mutual_fund import REIT, SIP, FundHolding, InvIT
...
class MultiAssetPortfolioAggregator:
    ...
    def __init__(self, capital_allocation: CapitalAllocationPort | None = None) -> None:
...
class CapitalAllocationService(CapitalAllocationPort):
    ...
    def __init__(self, volatility_assumptions: dict[AssetClass, float] | None = None) -> None:
