...
class PortfolioOptimizer:
    ...
    def __init__(self, n_grid: int = 1000) -> None:
        """Args:
    ...
    def optimize(self, method: str,
        ...
        method_map = {
            ...
            "erc": self.equal_risk_contribution,
        }
        ...
        return fn(returns, cov_matrix, risk_free_rate)  # type: ignore[no-any-return]
...
if __name__ == "__main__":
    ...
    ap.add_argument("--method", default="max_sharpe",
                    choices=["max_sharpe", "min_vol", "risk_parity", "max_div", "efficient_frontier", "cvar", "erc"])
    ...
    if args.json:
        if isinstance(result, EfficientFrontierResult):
            ...
            print(json.dumps(result.to_dict(), indent=2))
    elif isinstance(result, EfficientFrontierResult):
        print(result.summary())
    else:
        print(result.summary())
