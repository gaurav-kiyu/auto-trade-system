"""
import warnings
warnings.warn("signal_engine.py is deprecated - use core.signal_service, core.adaptive_signal, or core.pure_index_signal instead.", DeprecationWarning, stacklevel=2)
