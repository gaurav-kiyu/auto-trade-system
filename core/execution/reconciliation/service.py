...
class ReconciliationService:
    ...
    def _freeze_trading(self, reason: TradingFreezeReason, details: str) -> None:
    ...
    def _fetch_broker_positions(self, broker_adapter: Any) -> list[dict]:
        ...
        try:
            ...
            if hasattr(broker_adapter, "_port") and hasattr(broker_adapter._port, "get_positions"):
    ...
    def _determine_freeze_reason(
        ...
        if ReconciliationState.STALE_ORDER in type_counts:
            return TradingFreezeReason.STALE_ORDERS_UNRESOLVED
        if ReconciliationState.QUANTITY_MISMATCH in type_counts:
    ...
    def _mark_order_terminal(self, order_id: str, status: str) -> None:
    ...
    def _record_unrecorded_fill(self, issue: ReconciliationIssue) -> None:
