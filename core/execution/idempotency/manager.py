...
class IdempotencyManager:
    ...
    def __init__(self, cache_size: int = 1000, expiry_hours: int = 24, persistence_path: str | None = None) -> None:
    ...
    def _init_persistence(self) -> None:
        ...
        try:
            with self._lock, get_connection(self._persistence_path) as conn:
                conn.execute(
