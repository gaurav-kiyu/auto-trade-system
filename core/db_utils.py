...
Usage:
    ...
    conn = get_connection("db/trades.db")
    # ... use conn ...
    conn.close()

    # For async writes:
    from core.db_utils import AsyncDbWriter
    writer = AsyncDbWriter("db/trades.db")
...
class ConnectionPool:
    ...
    Example:
        pool = ConnectionPool("db/trades.db", min_size=2, max_size=8)
...
def create_database_port(
    ...
    *,
    ...
    Example:
        ...
        db = create_database_port("db/trades.db")
        db.connect()
...
def get_connection_cached(
    ...
    **kwargs: Any,
    ...
    Example:
        ...
        conn = get_connection_cached("db/trades.db", _conn_cache)
