...
# Default DB files to back up (auto-discovered as *.db in db/ folder)
_DEFAULT_DB_PATTERNS = ["db/*.db", "db/*.db-wal", "db/*.db-shm"]
...
def find_project_root() -> Path:
    ...
    markers = [".git", "json/index_config.defaults.json", "pyproject.toml"]
...
def create_backup(
    ...
    stem = db_path.stem  # e.g., "trades" from "db/trades.db"
