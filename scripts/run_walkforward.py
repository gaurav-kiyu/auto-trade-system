...
from core import WalkForwardEngine
from core.backtest_engine import BacktestConfig, CsvReplaySource, ReplayConfig
...
class StrategyEngine:
    """Inline wrapper replicating the deleted StrategyEngine for walkforward CLI."""
...
def main() -> int:
    ...
    parser.add_argument("--config", default="json/config.json")
