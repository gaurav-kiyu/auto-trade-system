...
_RULES: list[dict] = [
    {
        ...
        "exclude_files": {
            ...
            # ── pattern definitions (false positives - not actual calls) ──
    ...
    },
    {
        ...
        "exclude_files": {
            ...
            "core/chaos/__init__.py",     # intentional chaos engineering sleep
            "core/db_utils.py",           # retry back-off sleep
            "core/execution/retry_policy/manager.py", # retry back-off sleep
            "core/wal/journal.py",        # async writer throttle sleep
            "core/yf_data_provider.py",   # rate-limit sleep in data provider
            "index_app/domains/broker/factory.py", # broker connection retry sleep
        },
        "code_only": True,
        "severity": "warn",
    },
