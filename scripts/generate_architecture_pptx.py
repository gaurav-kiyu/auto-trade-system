...
def build_pptx(output_path: Path) -> None:
    ...
    _add_text_box(slide, Inches(1), Inches(3.0), Inches(11.333), Inches(1),
                  "Architecture Presentation - v2.57.1", font_size=28, color=MEDIUM_BLUE,
                  alignment=PP_ALIGN.CENTER)
    ...
    headers = ["Dimension", "Previous (v2.44)", "Current (v2.57.1)"]
    data_rows = [
    ...
    _add_text_box(slide, Inches(0.5), Inches(1.3), Inches(12), Inches(0.5),
                  "Status: Production Ready - v2.57.1", font_size=22, bold=True, color=GREEN)
