#!/usr/bin/env python3
"""Full System Certification Runner — OPB
...
if not VERSION:
    raise RuntimeError(f"Empty canonical VERSION file: {_VERSION_FILE}")
...
<head>
<meta charset="UTF-8">
<title>Full System Certification — OPB v{VERSION}</title>
<style>
...
<body>
<div class="header">
  <h1>🔬 Full System Certification — OPB v{VERSION}</h1>
...
<footer>
  Generated by <code>scripts/run_certify.py</code> — OPB Full System Certification v{VERSION}
</footer>
</body>
</html>"""
    return html
...
def main() -> int:
    ...
    print("=" * 70)
    print(f"  🔬 FULL SYSTEM CERTIFICATION — OPB v{VERSION}")
    print("=" * 70)
